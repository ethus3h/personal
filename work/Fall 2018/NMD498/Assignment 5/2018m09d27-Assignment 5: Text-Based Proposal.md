...
This describes hypothetical progress of two people, assuming the community is already running, and has courses and resources available. This provides an illustration of how the project would work. (Initial bootstrapping would need people to support themselves independently while constructing the infrastructure.)
...
- A: 0 credits, no qualifications; still taking the course.
...
### Day 4.
- A: 3 credits; office skills qualification.
