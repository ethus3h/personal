...
public class ExportPackage {
  ...
  static void ExportExample () {
    AssetDatabse.ExportPackage("Assets/Fastook_Coroutines", "Fastook_Coroutines.unitypackage", ExportPackageOptions.Interactive | ExprotPackageOptions.IncludeDependencies | ExportPackageOptions.recurse | ExportPackageOptions.IncludeLibrraryAsets);
  }
}
```
