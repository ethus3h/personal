...
class Wanderer {
  ...
  void tick() {
    ...
    System.out.println(Integer.toString((int)followTendency)+"|Mood="+Integer.toString(getMood())+"|Pty="+Integer.toString(getPersonality())+"|Spd="+Float.toString(speed)+"|Mdist="+Integer.toString(mouseDistFromHome));
