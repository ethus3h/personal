...
class Wanderer {
  ...
  void tick() {
    ...
    System.out.println(Integer.toString((int)followTendency)+"|Mood="+Integer.toString(getMood())+"|Pty="+Integer.toString(getPersonality())+"|Spd="+Integer.toString((int)(speed*100))+"|Mdist="+Integer.toString(mouseDistFromHome));
